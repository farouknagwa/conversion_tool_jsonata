...
\draw [dashed] (c)--(x);
%
\draw[|-|,thin] ($(c)!-6mm*\preserve!90:(d)$)--node[color=blue,fill=white,sloped] {$4{,}8\ \textrm{jardas}$} ($(d)!-6mm*\preserve!-90:(c)$);
\draw[|-|,thin] ($(d)!-6mm*\preserve!90:(x)$)--node[color=blue,fill=white,sloped] {$2{,}5\ \textrm{jardas}$} ($(x)!-6mm*\preserve!-90:(d)$);
\draw[|-|,thin] ($(b)!-6mm*\preserve!90:(c)$)--node[color=blue,fill=white,sloped] {$x\ \textrm{jardas}$} ($(c)!-6mm*\preserve!-90:(b)$);
%
